                ...
                H = function(e) {
                    ...
                    return (0, u.default)(a, [{
                        ...
                        value: function() {
                            ...
                            var m, v, C = (0, s.default)(F.default.profile, (e = {}, (0, o.default)(e, F.default.nonClickProfile, l.isSentByMe), (0, o.default)(e, F.default.profileNarrow, this.state.narrow), (0, o.default)(e, F.default.profileMac, !w.default.isRTL()), e)),
                                S = (0, s.default)(F.default.profile, F.default.measuringProfile, (0, o.default)({}, F.default.profileMac, !w.default.isRTL())),
                            ...
                            var D = this.props.statusV3.contact;
                            D.isMe || D.isPSA || (v = f.default.createElement(P.default, {
                                handlers: {
                                    left: N,
                                    right: N
                                }
                            ...
                            var I, O = (0, s.default)(F.default.playerBackground, (0, o.default)({}, F.default.media, u)),
                                R = (0, s.default)(F.default.progressBackdrop, (0, o.default)({}, F.default.progressBarBackdropNarrow, this.state.narrow));
                            return l.type !== g.default.MSG_TYPE.CHAT && (I = f.default.createElement("div", {
                                className: R
                            ...
                            }, k, y, I, p, c, f.default.createElement("div", {
                                className: O,
                                style: t
                            }), a, m, v)))
                        }
        ...
        27124: (e, t, a) => {
            ...
            var o = r(a(59713)),
                ...
                D = function(e) {
                    ...
                    function a() {
                        var e;
                        (0, l.default)(this, a), (e = t.apply(this, arguments)).onClickProgressBar = function(t) {
                            ...
                            if ((!a || t !== a.msgIdx) && a) {
                                ...
                                })).catchType(v.Unmount, (function() {})).catchType(h.EphemeralDrop, (function() {})).catchType(T.InvalidStatusV3Iterator, (function() {
                            ...
                            t && e._statusV3Snapshot.hasNext(t) && e._statusV3Snapshot.getNext(t).checkpoint(e.props.rejectOnUnmount()).then((function(t) {
                                ...
                                if (a.type === m.default.MSG_TYPE.CHAT) g.default.load(a.font).catch((function() {}));
                                else {
                                    var n = a.mediaData;
                            ...
                            if (t && e._statusV3Snapshot.hasPrev(t)) {
                                ...
                                e._statusV3Snapshot.getPrev(t).checkpoint(e.props.rejectOnUnmount()).then((function(t) {
                                    t.statusIdx === a ? e.setState({
                                        ...
                                        transitioning: !0
                                    }), (0, c.delayMs)(200).checkpoint(e.props.rejectOnUnmount()).then((function() {
                                        e.setState({
                                            iterator: t,
                                            transitioning: !1
                                        })
                                    })).catchType(v.Unmount, (function() {})))
                                })).catchType(v.Unmount, (function() {})).catchType(h.EphemeralDrop, (function() {})).catchType(T.InvalidStatusV3Iterator, (function() {
                        ...
                        if (e.props.quotedMsgKey) {
                            ...
                            var r = e.props.quotedMsgKey,
                                o = n.msgs.getModelsArray().findIndex((function(e) {
                            ...
                            if (-1 !== o) {
                                ...
                                u.checkpoint(e.props.rejectOnUnmount()).then((function(t) {
                                    ...
                                    __LOG__(3)`Invalid iterator while loading first unread msg`, p.default.openToast(f.default.createElement(b.default, {
                                        msg: E.default.t(1408),
                                        id: (0, b.genId)()
                                ...
                                }))) : (e.props.onMsgNotFound && e.props.onMsgNotFound(), p.default.openToast(f.default.createElement(b.default, {
                                    msg: E.default.t(1408),
                                    id: (0, b.genId)()
                                })), e.props.closeStatusViewer())
                            })).catch((function() {
                                p.default.openToast(f.default.createElement(b.default, {
                                    msg: E.default.t(1408),
                                    id: (0, b.genId)()
                                })), e.props.closeStatusViewer()
                            })).finally((function() {
                    ...
                    return (0, u.default)(a, [{
                        ...
                        key: "render",
                        value: function() {
                            var e, t, a, n, r, l, u, i, d = this,
                                c = this.state.iterator;
                            c && (l = (r = this._statusV3Snapshot).statuses[c.statusIdx], u = l.statusV3, i = l.msgs[c.msgIdx], r.hasPrev(c) && (a = f.default.createElement("div", {
                                className: w.default.chevronLeft
                            }, f.default.createElement(M.default, {
                                name: "chevron-left"
                            })), n = f.default.createElement("div", {
                                className: w.default.chevronLeftBg,
                                onClick: this.onPrev
                            })), r.hasNext(c) && (e = f.default.createElement("div", {
                                className: w.default.chevronRight
                            }, f.default.createElement(M.default, {
                                name: "chevron-right"
                            })), t = f.default.createElement("div", {
                                className: w.default.chevronRightBg,
                                onClick: function() {
                                    d.onNext(), d.markRead(u, i)
                                }
                            })));
                            var p, m = {
                                left: this.onPrev,
                            ...
                            !this.state.transitioning && !this.state.loading && i && c && l && u && (p = f.default.createElement("div", {
                                className: w.default.playerContainer,
                                key: i.id
                            }, f.default.createElement(k.default, {
                                key: i.id,
                                statusV3: u,
                            ...
                            var h, v = (0, s.default)(w.default.v3X, (0, o.default)({}, w.default.v3X_mac, E.default.isRTL())),
                                g = f.default.createElement("button", {
                                    className: v,
                                    onClick: function() {
                                        return d.props.closeStatusViewer(!0)
                                    }
                                }, f.default.createElement(M.default, {
                                    name: "x-viewer"
                                })),
                                C = (0, s.default)(w.default.backIcon, (0, o.default)({}, w.default.backIcon_mac, !E.default.isRTL())),
                                S = f.default.createElement("button", {
                                    className: C,
                                    onClick: function() {
                                        return d.props.closeStatusViewer()
                                    }
                                }, f.default.createElement(M.default, {
                                    name: "back",
                                    directional: !0
                                }));
                            return this.state.loading && (h = f.default.createElement("div", {
                                className: w.default.mediaStateControls
                            }, f.default.createElement("button", null, f.default.createElement(P.default, {
                                size: 50,
                                stroke: 4,
                                color: "white"
                            })))), f.default.createElement(_.default, {
                                ...
                                className: w.default.viewer,
                                "data-animate-status-v3-viewer": !0
                            }, g, S, n, a, t, e, h, f.default.createElement(N.default, {
