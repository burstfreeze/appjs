    ...
    [4410], {
        ...
        74410: (e, a, l) => {
            ...
            var n, r = t(l(63038)),
                ...
                P = l(59175),
                h = l(8297),
                v = new o.WapParser("productListResponse", (function(e) {
                    ...
                    return a.forEachChildWithTag("product", (function(e) {
                        ...
                        if (a) {
                            ...
                            (null == t ? void 0 : t.contentString()) === k.INVALID_PRODUCT_TOKEN ? l.push({
                                id: a.contentString(),
                                status: k.INVALID_PRODUCT_TOKEN
                            }) : l.push((0, f.parseProductNode)(e))
                        }
                    })), l
                })),
                F = function() {
                            ...
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return l = a.catalogWid, t = a.productIds, n = a.width, r = a.height, i = a.directConnectionEncryptedInfo, o = (0, s.wap)("iq", {
                                        ...
                                        jid: (0, S.USER_JID)((0, h.createWid)(l))
                                    }, t.map((function(e) {
                                        return (0, s.wap)("product", null, (0, s.wap)("id", null, e))
                                    })).concat((0, p.default)([(0, s.wap)("width", null, n.toString()), (0, s.wap)("height", null, r.toString()), i ? (0, s.wap)("direct_connection_encrypted_info", null, i) : null])))), e.next = 4, (0, g.sendIq)(o, v);
                                case 4:
                                    if ((c = e.sent).success) {
                                        e.next = 9;
                                        break
                ...
                K = function() {
                    var e = (0, i.default)(u.default.mark((function e(a) {
                        var t, i, s, o, p, g, y, m, f, k, S, h, v;
                        return u.default.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.prev = 0, s = a.catalogWid, o = a.productIds, p = a.width, g = a.height, y = a.directConnectionEncryptedInfo, e.next = 4, (0, c.fetchQuery)(void 0 !== n ? n : n = l(90717), {
                                        request: {
                                            product_list: {
                                                jid: s.toString(),
                                                ...
                                                width: String(p),
                                                height: String(g),
                                                direct_connection_encrypted_info: y,
                                                locale: (0, c.getLocaleVariable)()
                                            }
                                        }
                                    });
                                case 4:
                                    return m = e.sent, e.abrupt("return", (0, d.default)(null == m || null === (t = m.xwa_product_catalog_get_product_list) || void 0 === t || null === (i = t.product_list) || void 0 === i ? void 0 : i.products.map(_.parseProductGraphQL), "data?.xwa_product_catalog_get_product_list?.product_list?.products.map(parseProductGraphQL)"));
                                case 8:
                                    e.prev = 8, e.t0 = e.catch(0), S = null !== (f = null === (k = e.t0.source) || void 0 === k ? void 0 : k.errors) && void 0 !== f ? f : [], h = (0, r.default)(S, 1), v = h[0], e.t1 = null == v ? void 0 : v.code, e.next = 2498043 === e.t1 || 2498042 === e.t1 || 2498045 === e.t1 || 2498044 === e.t1 ? 14 : 2498046 === e.t1 ? 15 : 16;
                                    break;
                                case 14:
                                    throw new P.ServerStatusCodeError(400, e.t0.message);
                                case 15:
                                    throw new P.ServerStatusCodeError(421);
                                case 16:
                ...
                C = (0, y.defineWebPersistedJob)().finalStep("sendStanza", (function(e) {
                    return ((0, m.graphQLForCatalogM1Enabled)() ? K : F)(e)
                })).end();
            a.QueryProductListCatalog = C
        }
    }
]);