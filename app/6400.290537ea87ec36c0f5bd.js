...
(self.webpackChunkwhatsapp_web_client = self.webpackChunkwhatsapp_web_client || []).push([
    [6400], {
                ...
                return (h = (0, u.default)(s.default.mark((function e(t) {
                    ...
                    return s.default.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 23:
                                if (v = e.sent, b = (0, o.encodeB64)(v), K = (0, o.encodeB64)(t.hash), b === K) {
                                    e.next = 28;
                                    break
                                }
                                throw Error(`validateLocalKeyBundle: hash mismatch remote:${K} local:${b}`);
                            case 28:
        ...
        36539: (e, t, r) => {
            ...
            function K() {
                return (K = (0, u.default)(s.default.mark((function e() {
                    var t, r, a, u, c, d, h, b, K, P, w, k, S;
                    return s.default.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return t = f.ServerProps.maxKeys, e.next = 3, n.all([_.waSignalStore.getRegistrationInfo(), _.waSignalStore.getSignedPreKey()]);
                            case 3:
                            ...
                            case 9:
                                return d = u.registrationId, h = u.identityKeyPair, e.next = 12, _.waSignalStore.getOrGenPreKeys(t, y.generatePreKeyPair).then((function(e) {
                                    ...
                                    return [(0, l.wap)("iq", {
                                        ...
                                        type: "set",
                                        to: l.S_WHATSAPP_NET
                                    }, (0, l.wap)("registration", null, (0, l.BIG_ENDIAN_CONTENT)(d)), (0, l.wap)("type", null, p.default.KEY_BUNDLE_TYPE), (0, l.wap)("identity", null, h.pubKey), (0, l.wap)("list", null, e.map(g.xmppPreKey)), (0, g.xmppSignedPreKey)(c)), e[e.length - 1].keyId]
                                }));
                            case 12:
                                return b = e.sent, K = (0, i.default)(b, 2), P = K[0], w = K[1], e.prev = 16, e.next = 19, (0, o.waitForConnection)().then((function() {
                                    return _.waSignalStore.markKeyAsUploaded(w)
                                })).then((function() {
                                    return (0, o.deprecatedSendIqWithoutRetry)(P, v)
                                }));
                            case 19:
                                if (!(k = e.sent).success) {
                                    e.next = 24;
                                ...
                                return _.waSignalStore.setServerHasPreKeys(!0), __LOG__(2)`_uploadPreKeys: ${t} keys uploaded, raw stanza size: ${P.toString().length}b`, e.abrupt("return", {
                                    success: !0
                                });
                            case 24:
                                return (S = k.errorCode) >= 500 ? __LOG__(3)`_uploadPreKeys: server requested backoff ${S} (count: ${t}, size: ${P.toString().length}b)` : 406 === S ? __LOG__(3)`_uploadPreKeys: uploaded invalid keys (count: ${t}, size: ${P.toString().length}b)` : __LOG__(3)`_uploadPreKeys: unrecognized error ${S} (count: ${t}, size: ${P.toString().length}b)`, e.abrupt("return", {
