    ...
    [9152], {
        ...
        69152: (e, t, n) => {
            ...
            var u = r(n(87757)),
                ...
                b = (0, d.defineWebPersistedJob)().finalStep("sendStanza", function() {
                            ...
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return n = t.businessJid, r = (0, s.wap)("iq", {
                                        ...
                                        jid: (0, p.USER_JID)((0, c.createWid)(n))
                                    })), e.next = 4, (0, f.sendIq)(r, l);
                                case 4:
                                    if ((i = e.sent).success) {
                                        e.next = 9;
                                        break
                                    }
                                    throw new o.ServerStatusCodeError(i.errorCode);
                                case 9:
