    ...
    [9451], {
        27856: function(e) {
            ...
            e.exports = function() {
                ...
                var f = A(Array.prototype.forEach),
                    p = A(Array.prototype.pop),
                    m = A(Array.prototype.push),
                    y = A(String.prototype.toLowerCase),
                    h = A(String.prototype.match),
                ...
                function K() {
                    ...
                    var me = U,
                        ...
                        we = H,
                        Te = null,
                        Ae = x({}, [].concat(W(O), W(k), W(D), W(N), W(C))),
                        Se = null,
                        xe = x({}, [].concat(W(L), W(P), W(I), W(F))),
                        Ee = null,
                        _e = null,
                        Oe = !0,
                        ke = !0,
                        ...
                        qe = null,
                        Ge = x({}, ["audio", "video", "img", "source", "image", "track"]),
                        We = null,
                        Ye = x({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
                        ...
                        tt = function(e) {
                            Xe && Xe === e || (e && "object" === (void 0 === e ? "undefined" : G(e)) || (e = {}), e = E(e), Te = "ALLOWED_TAGS" in e ? x({}, e.ALLOWED_TAGS) : Ae, Se = "ALLOWED_ATTR" in e ? x({}, e.ALLOWED_ATTR) : xe, We = "ADD_URI_SAFE_ATTR" in e ? x(E(Ye), e.ADD_URI_SAFE_ATTR) : Ye, qe = "ADD_DATA_URI_TAGS" in e ? x(E(Ge), e.ADD_DATA_URI_TAGS) : Ge, He = "FORBID_CONTENTS" in e ? x({}, e.FORBID_CONTENTS) : Ve, Ee = "FORBID_TAGS" in e ? x({}, e.FORBID_TAGS) : {}, _e = "FORBID_ATTR" in e ? x({}, e.FORBID_ATTR) : {}, Be = "USE_PROFILES" in e && e.USE_PROFILES, Oe = !1 !== e.ALLOW_ARIA_ATTR, ke = !1 !== e.ALLOW_DATA_ATTR, De = e.ALLOW_UNKNOWN_PROTOCOLS || !1, Re = e.SAFE_FOR_TEMPLATES || !1, Ne = e.WHOLE_DOCUMENT || !1, Le = e.RETURN_DOM || !1, Pe = e.RETURN_DOM_FRAGMENT || !1, Ie = !1 !== e.RETURN_DOM_IMPORT, Fe = e.RETURN_TRUSTED_TYPE || !1, Ce = e.FORCE_BODY || !1, Ue = !1 !== e.SANITIZE_DOM, je = !1 !== e.KEEP_CONTENT, ze = e.IN_PLACE || !1, we = e.ALLOWED_URI_REGEXP || we, Je = e.NAMESPACE || Qe, Re && (ke = !1), Pe && (Le = !0), Be && (Te = x({}, [].concat(W(C))), Se = [], !0 === Be.html && (x(Te, O), x(Se, L)), !0 === Be.svg && (x(Te, k), x(Se, P), x(Se, F)), !0 === Be.svgFilters && (x(Te, D), x(Se, P), x(Se, F)), !0 === Be.mathMl && (x(Te, N), x(Se, I), x(Se, F))), e.ADD_TAGS && (Te === Ae && (Te = E(Te)), x(Te, e.ADD_TAGS)), e.ADD_ATTR && (Se === xe && (Se = E(Se)), x(Se, e.ADD_ATTR)), e.ADD_URI_SAFE_ATTR && x(We, e.ADD_URI_SAFE_ATTR), e.FORBID_CONTENTS && (He === Ve && (He = E(He)), x(He, e.FORBID_CONTENTS)), je && (Te["#text"] = !0), Ne && x(Te, ["html", "head", "body"]), Te.table && (x(Te, ["tbody"]), delete Ee.tbody), i && i(e), Xe = e)
                        },
                        nt = x({}, ["mi", "mo", "mn", "ms", "mtext"]),
                        rt = x({}, ["foreignobject", "desc", "title", "annotation-xml"]),
                        ot = x({}, k);
                    x(ot, D), x(ot, R);
                    var at = x({}, N);
                    x(at, M);
                    var it = function(e) {
                        ...
                        st = function(e, n) {
                            ...
                            if (n.removeAttribute(e), "is" === e && !Se[e])
                                if (Le || Pe) try {
                                    lt(n)
                                } catch (e) {} else try {
                                    n.setAttribute(e, "")
                        ...
                        ut = function(e) {
                            ...
                            return e && n && i.insertBefore(r.createTextNode(n), i.childNodes[0] || null), Je === Qe ? ce.call(t, Ne ? "html" : "body")[0] : Ne ? t.documentElement : i
                        },
                        ct = function(e) {
                            return se.call(e.ownerDocument || e, e, u.SHOW_ELEMENT | u.SHOW_COMMENT | u.SHOW_TEXT, null, !1)
                        },
                        dt = function(e) {
                            return !(e instanceof A || e instanceof S || "string" == typeof e.nodeName && "string" == typeof e.textContent && "function" == typeof e.removeChild && e.attributes instanceof d && "function" == typeof e.removeAttribute && "function" == typeof e.setAttribute && "string" == typeof e.namespaceURI && "function" == typeof e.insertBefore)
                        },
                        ft = function(e) {
                    ...
                    return t.sanitize = function(r, a) {
                        ...
                        if ((Ze = !r) && (r = "\x3c!--\x3e"), "string" != typeof r && !ft(r)) {
                            ...
                            if ("string" != typeof(r = r.toString())) throw T("dirty is not a string, aborting")
                        }
                        if (!t.isSupported) {
                        ...
                        if (Me || tt(a), t.removed = [], "string" == typeof r && (ze = !1), ze);
                            ...
                            if (!Le && !Re && !Ne && -1 === r.indexOf("<")) return oe && Fe ? oe.createHTML(r) : r;
