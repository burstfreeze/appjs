                ...
                return e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
                    return this.storage.isTrustedIdentity(this.remoteAddress.toString(), A.identityKey, this.storage.Direction.SENDING).then((function(t) {
                        ...
                        return this.storage.loadSession(t).then(function(i) {
                            ...
                            return r.archiveCurrentState(), n && A && !EA.isEqual(n.indexInfo.remoteIdentityKey, A.indexInfo.remoteIdentityKey) && (__LOG__(2)`libsignal: processPreKey: deleting all sessions because identity has changed`, r.deleteAllSessions()), r.updateSessionState(A), Promise.all([this.storage.storeSession(t, r.prepareRecord()), this.storage.saveIdentity(this.remoteAddress.toString(), A.indexInfo.remoteIdentityKey)])
                        }.bind(this))
                    }.bind(this))
                }.bind(this))
            },
                ...
                return this.storage.isTrustedIdentity(this.remoteAddress.toString(), e.identityKey.toArrayBuffer(), this.storage.Direction.RECEIVING).then(function(A) {
                    ...
                    if (!(r = A.getSessionByBaseKey(e.baseKey))) {
                        ...
                        return void 0 !== r && A.archiveCurrentState(), e.preKeyId && !t && __LOG__(2)`libsignal: Invalid prekey id`, this.initSession(!1, t, i, e.identityKey.toArrayBuffer(), e.baseKey.toArrayBuffer(), void 0, e.registrationId).then(function(t) {
                            return r && t && !EA.isEqual(r.indexInfo.remoteIdentityKey, t.indexInfo.remoteIdentityKey) && (__LOG__(2)`libsignal: deleting all sessions because identity has changed`, A.deleteAllSessions()), A.updateSessionState(t), this.storage.saveIdentity(this.remoteAddress.toString(), e.identityKey.toArrayBuffer()).then((function() {
                                return e.preKeyId
                            }))
                        }.bind(this))
                    }
                    ...
                    return this.getRecord(t).then(function(i) {
                        ...
                        return new lA(this.storage, this.remoteAddress).processV3(i, r).then(function(A) {
                            ...
                            return this.doDecryptWhisperMessage(r.message.toArrayBuffer(), e).then(function(A) {
                                ...
                                return e && r && !EA.isEqual(e.indexInfo.remoteIdentityKey, r.indexInfo.remoteIdentityKey) ? (__LOG__(2)`libsignal: promote the old session and update identity`, i.archiveCurrentState(), i.promoteState(e), this.storage.saveIdentity(t, e.indexInfo.remoteIdentityKey).then((function() {
                                    return A
                                }))) : A
