...
$libs = @("opus_1.3", "pjlib", "pjlib_util", "pjmedia", "samplerate", "srtp_2.2.0", "vpx_1.8.1", "webrtc_aec_v2", "webrtc_aecm_v2", "webrtc_agc_v2", "webrtc_codecs_v2", "webrtc_fec", "webrtc_ns_v2", "webrtc_rbe_v2", "webrtc_spl_v2", "webrtc_system_wrappers_v2", "webrtc_utility_v2", "yuv-1704", "windows-avdriver", "webrtc_pacing", "webrtc_aec3_ns")
