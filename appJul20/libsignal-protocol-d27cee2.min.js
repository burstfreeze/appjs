    ...
    CA(), e = e || {},
        ...
        function() {
            ...
            e.startWorker = function(A) {
                ...
                postMessage: function(A, e, t, i) {
                    console.log("postMessage", A, e, t, i)
        ...
        function() {
            ...
            function t(A) {
                ...
                return 33 == A.byteLength ? A.slice(1) : (__LOG__(4)`libsignal: WARNING: Expected pubkey of length 33, please report the ST and client that generated the pubkey`, A)
            }
        ...
        function() {
            ...
            e.crypto = {
                ...
                decrypt: function(e, t, i) {
                    console.log("libsignal decrypt - e, t, i", e, t, i)
                    return A.subtle.importKey("raw", e, {
                        name: "AES-CBC"
                    }, !1, ["decrypt"]).then((function(e) {
                        console.log("libsignal decrypt THEN - e ", e, " A: ", A)
                ...
                decrypt: function(A, t, i) {
                    console.log("libsignal decrypt (wrapper?), ", A, t, i)
    ...
    libsignal.KeyHelper = QA, (e = e || {}).protoText = {
            ...
            var A = [{
                    ...
                    migrate: function(A) {
                        ...
                        if (A.registrationId)
                            ...
                            for (e in t) - 1 === t[e].indexInfo.closed && __LOG__(2)`libsignal: V1 session storage migration error: registrationId`
                    }
                }],
                t = function() {
            ...
            return t.initRecordFromData = function(e) {
                ...
                archiveCurrentState: function() {
                    var A = this.getOpenSession();
                    void 0 !== A && (__LOG__(2)`libsignal: closing session`, A.indexInfo.closed = Date.now(), this.updateSessionState(A))
                },
                promoteState: function(A) {
                    __LOG__(2)`libsignal: promoting session`, A.indexInfo.closed = -1
                },
                removeOldChains: function(A) {
                    for (; A.oldRatchetList.length > 10;) {
                        ...
                        __LOG__(2)`libsignal: Deleting chain closed`, delete A[EA.toString(t.ephemeralKey)], A.oldRatchetList.splice(e, 1)
                    }
                },
                removeOldSessions: function() {
                    for (var A, e, t = this.sessions; Object.keys(t).length > 40;) {
                        ...
                        __LOG__(2)`libsignal: Deleting session closed at`, delete t[EA.toString(A)]
                    }
                },
                ...
                return e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
                    return this.storage.isTrustedIdentity(this.remoteAddress.toString(), A.identityKey, this.storage.Direction.SENDING).then((function(t) {
                        ...
                        return this.storage.loadSession(t).then(function(i) {
                            var r;
                            return (r = void 0 !== i ? e.SessionRecord.initRecordFromData(i) : new e.SessionRecord).archiveCurrentState(), r.updateSessionState(A), Promise.all([this.storage.storeSession(t, r.prepareRecord()), this.storage.saveIdentity(this.remoteAddress.toString(), A.indexInfo.remoteIdentityKey)])
                        }.bind(this))
                    }.bind(this))
                }.bind(this))
            },
            processV3: function(A, e) {
                ...
                return this.storage.isTrustedIdentity(this.remoteAddress.toString(), e.identityKey.toArrayBuffer(), this.storage.Direction.RECEIVING).then(function(A) {
                    ...
                    if (!(r = A.getSessionByBaseKey(e.baseKey))) {
                        ...
                        return void 0 !== r && A.archiveCurrentState(), e.preKeyId && !t && __LOG__(2)`libsignal: Invalid prekey id`, this.initSession(!1, t, i, e.identityKey.toArrayBuffer(), e.baseKey.toArrayBuffer(), void 0, e.registrationId).then(function(t) {
                            return A.updateSessionState(t), this.storage.saveIdentity(this.remoteAddress.toString(), e.identityKey.toArrayBuffer()).then((function() {
                                return e.preKeyId
                            }))
                        }.bind(this))
                    }
            ...
            decryptWithSessionList: function(A, e, t) {
                console.log("libsignal decrypt with session list", A, e, t)
            ...
            decryptWhisperMessage: function(A, t) {
                console.log("libsignal decrypt whisper message", A, t)
                return A = dcodeIO.ByteBuffer.wrap(A, t).toArrayBuffer(), e.SessionLock.queueJobForNumber(this.remoteAddress.toString(), function() {
            ...
            decryptPreKeyWhisperMessage: function(A, t) {
                console.log("libsignal decrypt preykey whisper message", A, t)
                    ...
                    return this.getRecord(t).then(function(i) {
                        ...
                        return new lA(this.storage, this.remoteAddress).processV3(i, r).then(function(A) {
                            ...
                            return this.doDecryptWhisperMessage(r.message.toArrayBuffer(), e).then(function(r) {
                                return i.updateSessionState(e), this.storage.storeSession(t, i.prepareRecord()).then(function() {
            ...
            doDecryptWhisperMessage: function(A, t) {
                console.log("libsignal DO decrypt whisper message", A, t)
                ...
                return void 0 === t ? Promise.reject(new Error("No session found to decrypt message from " + this.remoteAddress.toString())) : (-1 != t.indexInfo.closed && __LOG__(2)`libsignal: decrypting message for closed session`, this.maybeStepRatchet(t, o, g.previousCounter).then(function() {
        ...
        function() {
            ...
            decryptSenderKeyMessage: function(A, t) {
                console.log("libsignal decrypt senderkey message", A, t)
            ...
            decryptSenderKeyDistributionMessage: function(A) {
                console.log("libsignal decrypt sender key distribution message", A)
            ...
            console.log("GroupCipher, A: ", A, "e: ", e, "t: ", t)
            var i = new dA(A, e, t);
            console.log("da() is ", dA, " object is i: ", i)
